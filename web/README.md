...
| `NUXT_PUBLIC_SERVER_HOST`  | Web 界面域名或 IP                      | —            |
| `NUXT_PUBLIC_SSH_HOST`     | SSH 服务主机名（留空则同 SERVER_HOST） | —            |
| `NUXT_PUBLIC_SSH_PORT`     | SSH 服务端口                           | `22`         |
...
export function streamOperation(url: string) {
